              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                                  ...
                                  children: List.generate(data['p_colors'].length,
                                          (index) => Stack(
                                            ...
                                            children: [
                                              VxBox().size(40, 40)
                                                  .roundedFull
                                                  .color(Color(data['p_colors'][index]).withOpacity(1.0)).margin(const EdgeInsets.symmetric(horizontal: 4)).make()
                                              .onTap((){
                        ...
                        Obx(() => Row(
                            children: [
                              IconButton(onPressed: (){
                                ...
                                controller.calculateTotalPrize(int.parse(data['p_price']));
                    ...
                    10.heightBox,
                    "Product you may also like".text.fontFamily(bold).size(16).color(darkFontGrey).make(),
                    10.heightBox,
                    ...
                    SingleChildScrollView(
                      ...
                      child: Row(
                        children: List.generate(10, (index) => Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [Image.asset(imgP1, width: 150, fit: BoxFit.cover,),
                              10.heightBox,
                              "Laptop 4GB/264".text.fontFamily(semibold).color(darkFontGrey).make(),
                              10.heightBox,
                              "\$600".text.color(redColor).fontFamily(bold).size(16).make()
                            ]
                        ).box.white.rounded.margin(const EdgeInsets.symmetric(horizontal: 4)).rounded.padding(const EdgeInsets.all(8)).make()),
                      ),
                    )
                  ],
                ),
