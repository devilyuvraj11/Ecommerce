import 'package:ecommerce/Screens/profile_screen/orders_screen/components/order_place_detail..dart';
import 'package:ecommerce/Screens/profile_screen/orders_screen/components/order_status.dart';
...
class OrdersDeatail extends StatelessWidget {
  final Map<String, dynamic> data;
  const OrdersDeatail({super.key, required this.data});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: "Order Details".text.fontFamily(semibold).color(darkFontGrey).makeCentered(),
      ),
      body: Padding(
            ...
            children: [
              Column(
                children: [
                  ...
                  orderStatus(color: Colors.yellowAccent, icon: Icons.directions_bike, title: "On Delivery", showDone: data['order_on_delivery']),
